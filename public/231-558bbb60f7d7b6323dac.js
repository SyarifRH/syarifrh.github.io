    ...
    7231: function() {
      !(function() {
        ...
        if ('undefined' !== typeof window) {
          const t = window.navigator.userAgent.match(/Edge\/(\d{2})\./);
          const e = t ? parseInt(t[1], 10) : null;
          const i = !!e && 16 <= e && e <= 18;
          if ('objectFit' in document.documentElement.style == 0 || i) {
            const n = function(t, e, i) {
              let n; let o; let l; let a; let d;
            ...
            const o = function(t) {
              let e = t.dataset ? t.dataset.objectFit : t.getAttribute('data-object-fit');
              let i = t.dataset ? t.dataset.objectPosition : t.getAttribute('data-object-position');
              (e = e || 'cover'), (i = i || '50% 50%');
              const o = t.parentNode;
              return (
                (function(t) {
                  const e = window.getComputedStyle(t, null);
                  const i = e.getPropertyValue('position');
                  const n = e.getPropertyValue('overflow');
                  const o = e.getPropertyValue('display');
            ...
            const l = function(t) {
              if (void 0 === t || t instanceof Event) {t = document.querySelectorAll('[data-object-fit]');} else if (t && t.nodeName) {t = [t];} else if ('object' !== typeof t || !t.length || !t[0].nodeName) {return !1;}
              for (let e = 0; e < t.length; e++) {
                if (t[e].nodeName) {
                  const n = t[e].nodeName.toLowerCase();
                  if ('img' === n) {
                    if (i) {continue;}
                    t[e].complete
                      ? o(t[e])
