(self.webpackChunkv4 = self.webpackChunkv4 || []).push([
  [470],
  {
    ...
    2757: function(t) {
      ...
      const b = '(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?';
      const y = '[\\ufe0e\\ufe0f]?';
      const E = `${y + b  }(?:\\u200d(?:${  [`[^${  e  }]`, s, x].join('|')  })${  y  }${b  })*`;
      const h = `(?:${  [i, s, x].join('|')  })${  E}`;
      const A = RegExp(
        [
          `${d  }?${  c  }+${  m  }(?=${  [a, d, '$'].join('|')  })`,
          `${v  }+${  g  }(?=${  [a, d + p, '$'].join('|')  })`,
...
//# sourceMappingURL=component---src-pages-pensieve-tags-js-51590b274df8e43b87a2.js.map
