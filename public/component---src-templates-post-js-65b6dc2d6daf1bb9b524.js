(self.webpackChunkv4 = self.webpackChunkv4 || []).push([
  [851],
  {
    9857: function(e, t, n) {
      ...
      const s = f.default.header.withConfig({
    ...
    2757: function(e) {
      ...
      const h = '(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?';
      const b = '[\\ufe0e\\ufe0f]?';
      const y = `${b + h  }(?:\\u200d(?:${  [`[^${  t  }]`, s, d].join('|')  })${  b  }${h  })*`;
      const E = `(?:${  [f, s, d].join('|')  })${  y}`;
      const A = RegExp(
        [
          `${x  }?${  c  }+${  g  }(?=${  [a, x, '$'].join('|')  })`,
          `${m  }+${  v  }(?=${  [a, x + p, '$'].join('|')  })`,
...
//# sourceMappingURL=component---src-templates-post-js-65b6dc2d6daf1bb9b524.js.map
